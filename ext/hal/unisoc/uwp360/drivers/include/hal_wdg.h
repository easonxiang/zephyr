...
#define WDG_IRQ_MSK_BIT BIT(0)
	...
	static inline void uwp360_wdg_lock(void)
	{
		sci_write32(REG_WDG_LOCK, WDG_LOCK_KEY);
	}

	static inline void uwp360_wdg_unlock(void)
	{
		sci_write32(REG_WDG_LOCK, WDG_UNLOCK_KEY);
	}

	static inline void uwp360_wdg_set_mode(u32_t mode)
	{
		u32_t mode_bitmap;
	...
	static inline void uwp360_wdg_load(u32_t value)
	{
#ifndef WDG_NEWMODE
		u32_t cnt = 0;
#endif
	...
	static inline void uwp360_wdg_load_irq(u32_t value)
	{
#ifndef WDG_NEWMODE
		u32_t cnt = 0;
#endif
	...
	static inline void uwp360_wdg_clear_int(u32_t bitmap)
	{
		u32_t cnt = 0;
	...
	static inline void uwp360_wdg_enable(void)
	{
		uwp360_wdg_unlock();
	...
	static inline void uwp360_wdg_disable(void)
	{
		uwp360_wdg_unlock();
	...
	static inline void uwp360_wdg_int_clear(void)
	{
		uwp360_wdg_unlock();
	...
	static inline u32_t uwp360_wdg_get_counter(void)
	{
		u32_t value = 0;
