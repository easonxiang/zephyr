...
#define SFC_CMD_CFG			(BASE_SFC_CFG + 0x0000)
#define SFC_SOFT_REQ        (BASE_SFC_CFG + 0x0004)
#define SFC_TBUF_CLR        (BASE_SFC_CFG + 0x0008)
#define SFC_INT_CLR         (BASE_SFC_CFG + 0x000C)
#define SFC_STATUS          (BASE_SFC_CFG + 0x0010)
#define SFC_CS_TIMING_CFG   (BASE_SFC_CFG + 0x0014)
#define SFC_RD_SAMPLE_CFG   (BASE_SFC_CFG + 0x0018)
#define SFC_CLK_CFG         (BASE_SFC_CFG + 0x001C)
#define SFC_CS_CFG          (BASE_SFC_CFG + 0x0020)
#define SFC_ENDIAN_CFG      (BASE_SFC_CFG + 0x0024)
#define SFC_IO_DLY_CFG      (BASE_SFC_CFG + 0x0028)
#define SFC_WP_HLD_INIT     (BASE_SFC_CFG + 0x002C)
#define SFC_CMD_BUF0        (BASE_SFC_CFG + 0x0040)
#define SFC_CMD_BUF1        (BASE_SFC_CFG + 0x0044)
#define SFC_CMD_BUF2        (BASE_SFC_CFG + 0x0048)
#define SFC_CMD_BUF3        (BASE_SFC_CFG + 0x004C)
#define SFC_CMD_BUF4        (BASE_SFC_CFG + 0x0050)
#define SFC_CMD_BUF5        (BASE_SFC_CFG + 0x0054)
#define SFC_CMD_BUF6        (BASE_SFC_CFG + 0x0058)
#define SFC_CMD_BUF7        (BASE_SFC_CFG + 0x005C)
#define SFC_CMD_BUF8        (BASE_SFC_CFG + 0x0060)
#define SFC_CMD_BUF9        (BASE_SFC_CFG + 0x0064)
#define SFC_CMD_BUF10       (BASE_SFC_CFG + 0x0068)
#define SFC_CMD_BUF11       (BASE_SFC_CFG + 0x006C)
#define SFC_TYPE_BUF0       (BASE_SFC_CFG + 0x0070)
#define SFC_TYPE_BUF1       (BASE_SFC_CFG + 0x0074)
#define SFC_TYPE_BUF2       (BASE_SFC_CFG + 0x0078)

#define SFC_IEN             (BASE_SFC_CFG + 0x0204)
#define SFC_INT_RAW			(BASE_SFC_CFG + 0x0208)
#define SFC_INT_STS         (BASE_SFC_CFG + 0x020C)
