...
#ifndef _EIC_UWP360_H_
#define _EIC_UWP360_H_
...
typedef void (*uwp360_eic_callback_t) (int channel, void *user);

extern void uwp360_eic_set_callback(int channel,
		uwp360_eic_callback_t cb, void *arg);
extern void uwp360_eic_unset_irq_callback(int channel);
extern void uwp360_eic_enable(int channel);
extern void uwp360_eic_disable(int channel);
extern void uwp360_eic_set_trigger(int channel, int type);

#endif /* _EIC_UWP360_H_ */
